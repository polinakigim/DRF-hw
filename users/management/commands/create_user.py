...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            user.set_password('123')  # Здесь можно задать пароль или сделать его динамическим
            user.save()

            self.stdout.write(self.style.SUCCESS(f'Пользователь с email {email} успешно создан!'))
